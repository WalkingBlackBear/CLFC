...
while ( $row = mysql_fetch_array($result) )
  {
    ...
    $sql2 = '
      ...
      WHERE
        '.TABLE_BASKET_ALL.'.delcode_id = '.TABLE_DELCODE.'.delcode_id
        AND '.TABLE_DELCODE.'.hub = "'.mysql_real_escape_string ($hub).'"
      GROUP BY
    ...
    <table width="790">
      <tr>
        <td align="left">
          ...
          <br>Overall: $'.number_format($overall,2).'
          <table cellpadding=4>
            <tr>
              <th>Delivery Code</th>
...
$page_subtitle_html = '<span class="subtitle">Totals by Location</span>';
$page_title = 'Reports: Totals by Location';
