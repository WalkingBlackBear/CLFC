...
while ( $row = mysql_fetch_object($result) )
  {
    ...
    elseif ($row->unlisted_producer == 2)
      {
        $producer_list = '
      <li class="suspended'.$active_class.$pending_class.'"><a href="'.$_SERVER['PHP_SELF'].'?producer_id_you='.$row->producer_id.'">'.$active_display.$pending_display.''.htmlspecialchars($row->business_name, ENT_QUOTES).'</a> (Suspended)<br>(Only a producer admin can unsuspend the producer account)</li>';
      if ($row->producer_id == $_SESSION['producer_id_you'])
        $list_status_html = '
          <ul class="fancyList1">
            '.$producer_list.'<br>
...
if ($list_status_html)
  {
    $display .= '
        ...
        <img src="grfx/producer.png" width="32" height="32" align="left" hspace="2" alt="Producer info."><br>
...
$display .= '
    <img src="grfx/producer3.png" width="32" height="32" align="left" hspace="2" alt="Producer identity"><br>
