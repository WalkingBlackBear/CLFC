...
if (! $_SESSION['member_id'])
  {
    $display_form_top .= '
      <p>If you are already a member, please <a href="index_ofs.php?action=login">sign in here</a>.  Otherwise fill out the form below to become a member. Required fields are shown with an asterisk (*)</p>';
  }
else
  {
    $display_form_top .= '
      <br /><p class="bold">As an existing member, you can use the form below to update your membership information.</p>';
  }
      ...
      <tr>
        <td>
          <table>
            ...
            <tr>
              <td class="form_key"><strong>*&nbsp;City/Province/Postal Code:</strong></td>
        ...
        <td>
          <table>
            <tr>
              ...
              <td class="form_key" rowspan="3" valign="bottom"><strong>*&nbsp;Enter the word</strong><br><input maxlength="10" size="10" name="human_check" value="" tabindex="30"></td>
      ...
      <tr>
        <td><input type="checkbox" name="affirmation" value="yes"'.$affirmation_check.' tabindex="35">
          *&nbsp;I acknowledge that I have read and understand the '.SITE_NAME.' <a href="'.TERMS_OF_SERVICE.'" target="_blank">
          Member Information Statement</a>.
        </td>
      </tr>';
  }
...
$page_subtitle_html = '<span class="subtitle">'.($_SESSION['show_name'] ? 'Update Membership Info.' : 'New Member Form').'</span></h4>';
