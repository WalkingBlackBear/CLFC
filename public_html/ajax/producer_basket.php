...
//echo "<pre>RETURN_DATA: $return_data</pre>";
//echo "<pre>$extra_charge_total = (".$result_item_info['quantity']." - ".$result_item_info['out_of_stock'].") * ".$result_item_info['extra_charge']."</pre>";
  }
else
  {
