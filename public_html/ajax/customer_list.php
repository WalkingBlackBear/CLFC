...
if (! $basket_id)
  {
    ...
    if ($basket_info == 'delcode_id not set')
      {
        echo 'delcode_id not set';
        exit (1);
      }
...
// There seems to be a problem with basket_id -- at least for 'admin'
debug_print ("INFO: ", array (
  'member_id'=>$member_id,
  'delivery_id'=>$delivery_id,
  'basket_id'=>$basket_id,
