...
// RECEIVE PAYMENTS FORM ******************************************************
    case 'get_receive_payment_form':
      echo get_receive_payment_form ($_POST['member_id'],$_POST['basket_id'], '');
      break;
...
// POST RECEIVE PAYMENTS ******************************************************
    case 'receive_payment':
      ...
      if (preg_match('/^[0-9]*\.[0-9]{2}$/', $_POST['amount']) != 1)
      ...
      if (count($error_array) == 0)
      ...
      else
        {
          ...
          $return_content = 'ERROR     '.get_receive_payment_form ($_POST['member_id'],$_POST['basket_id'], $error_message);
        }
      echo $return_content;
      break;
...
function get_receive_payment_form ($member_id, $basket_id, $error_message)
  {
      ...
      <div id="receive_payment_row" class="data_row">'.
        ...
        <form id="receive_payment_form">
          <fieldset>
            ...
            <legend>
              Receive payment for member '.$member_id.'
            </legend>
            <span class="nobr">
            ...
            <span class="nobr">
              ...
              <input id=amount name=amount type=text required autofocus pattern="[0-9]*\.[0-9]{2}" autocomplete="off" value="'.$_POST['amount'].'">
            </span>
