    ...
    if ($_GET['subcategory_id'] != '')
      {
        ...
        $page_html .= '<form method="post" action="'.$_SERVER['PHP_SELF'].'?action=Update"><table>'."<br>\n";
        ...
        $page_html .= '</form><form method="post" action="'.$_SERVER['PHP_SELF'].'?action=List"><input type="submit" name="submit" value="CANCEL"></form>'."<br><br>\n";
        if ($number_of_products > 0)
          ...
          {
            $page_html .= ' <form method="post" action="'.$_SERVER['PHP_SELF'].'?action=Update"><input type="hidden" name="subcategory_id" value="'.$subcategory_id.'"><input type="submit" name="submit" value="Delete"></form>';
          }
      }
    elseif ($_GET['category_id'] != '')
      {
        ...
        if ($number_of_cats > 0)
          ...
          {
            $page_html .= ' <form method="post" action="'.$_SERVER['PHP_SELF'].'?action=Update"><input type="hidden" name="category_id" value="'.$category_id.'"><input type="submit" name="submit" value="Delete"></form>';
          }
      }
  }
...
if ($_GET['action'] == 'AddCategory')
  {
    ...
    $return_value = listCategoriesEdit (0, 1, "All Categories");
    $option_html = $return_value[1];
    $page_html .= '<form method="post" action="'.$_SERVER['PHP_SELF'].'?action=Add"><table>'."<br>\n";
    ...
    $page_html .= '</select>'."<td></tr>\n";
    $page_html .= '</tr></table><br><br>'."\n";
    $page_html .= '<input type="submit" name="type" value="Add Category"></form><form method="post" action="'.$_SERVER['PHP_SELF'].'?action=List"><input type="submit" name="submit" value="CANCEL"></form>'."<br>\n";
  }
...
if ($_GET['action'] == 'AddSubcategory')
  {
    ...
    $page_html .= '</select>'."<td></tr>\n";
    $page_html .= '</tr></table><br><br>'."\n";
    $page_html .= '<input type="submit" name="type" value="Add Subcategory"></form><form method="post" action="'.$_SERVER['PHP_SELF'].'?action=List"><input type="submit" name="submit" value="CANCEL"></form>'."<br>\n";
  }
        ...
        if ($_POST['subcategory_id'])
          {
            ...
            $page_html .= '<form action="'.$_SERVER['PHP_SELF'].'?action=Add" method="post">'."\n";
