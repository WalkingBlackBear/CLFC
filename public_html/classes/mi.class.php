        ...
        while ($result = mysql_fetch_array($query))
          {
            ...
            <tr>
              ...
              <td class="'.$discontinued_class.'">'.$discontinued_open.$result['first_name'].' '.$result['last_name'].'<br >('.$result['preferred_name'].')'.$discontinued_close.'</td>
              <td class="'.$discontinued_class.'">'.$discontinued_open.$result['business_name'].$discontinued_close.'</td>
              <td class="'.$discontinued_class.'">'.$discontinued_open.$result['email_address'].'<br>'.$result['email_address_2'].$discontinued_close.'</td>
              <td class="'.$discontinued_class.'">'.$discontinued_open.$result['username'].$discontinued_close.'</td>
              <td><a href="member_interface.php?action=edit&ID='.$result['member_id'].'">Edit</a></td>
            </tr>'; 
          }
        $content_members .= '
          </table>';
