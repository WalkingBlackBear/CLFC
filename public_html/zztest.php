<?php
	require('/home/cloverbe/public_html/clfc/wp-load.php');
...
elseif ((! $_SESSION['member_id']) && (!is_user_logged_in())) {
...
if (($_SESSION['member_id']) || (is_user_logged_in())) // the member is already logged in
  {
...
//echo '<div id="content" class="site-content" role="main" style="width: 100%; margin: 5px 0 10px 0;">';	
