...
$query = '
  ...
  ORDER BY
    ...
    '.NEW_TABLE_BASKETS.'.delcode_id ASC,
...
while($row = mysql_fetch_array($result))
  {
    ...
    $content .= '
          <li id="basket_id:'.$basket_id.'" class="c_complete"><a href="show_report.php?type=customer_invoice&delivery_id='.$delivery_id.'&member_id='.$member_id.'" target="_blank"><div class="c_list_cid">'.$ready_begin.$row['member_id'].$ready_end.'</div><div class="c_list_name">'.$hub.': '.$delcode_id.' ['.$last_name.', '.$first_name.']</div></a></li>';
  }
