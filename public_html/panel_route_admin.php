   ...
   <tr valign="top">
      <td align="left" width="50%">
        ...
        <ul class="fancyList1">
          ...
          <!--<li class="last_of_group"><strike><a href="delivery_zip.php">Members on Your Route</a></strike></li>-->
          ...
          <li class="last_of_group"><a href="delcode_activation.php">Activate Delivery Locations</a></li>
        </ul>
      </td>
      <td align="left" width="50%">
        <img src="grfx/launch.png" width="32" height="32" align="left" hspace="2" alt="Delivery Cycle Functions"><br>
