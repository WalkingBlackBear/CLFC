    ...
    $display .= '
        <tr>
          ...
          <td style="border-bottom:1px solid gray;font-size:70%;">
            ...
            <strike><a href="orders_prdcr_cust_storage.php?delivery_id='.$_REQUEST['delivery_id'].'&producer_id='.$row['producer_id'].'&display_only=true&output=pdf" target="_blank">PDF invoice</a></strike>
          </td>
          <td style="border-bottom:1px solid gray;font-size:70%;">';
    $query_weight = '
      SELECT
