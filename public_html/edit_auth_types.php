...
if ($_GET['content'] == 'members')
  {
    ...
    $member_form .= '
      ...
      <th><a href="'.$_SERVER['PHP_SELF'].'?content=members&page='.$page.'&sort=username">Username'.$sort_by['username'].'</a></th>
      <th><a href="'.$_SERVER['PHP_SELF'].'?content=members&page='.$page.'&sort=auth_type">Membership Type'.$sort_by['auth_type'].'</a></th>';
    $query = '
      SELECT
        member_id,
        pending,
