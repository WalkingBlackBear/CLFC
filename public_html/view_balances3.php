...
function get_ledger_body () {
  ...
  document.getElementById("ledger_body").innerHTML = "<img src=\"'.PATH.'grfx/food_throbber.gif\" class=\"throbber\">";
...
$page_specific_css = '
  ...
  .autocomplete-w1 {
     background:url('.PATH.'grfx/shadow.png) no-repeat bottom right;
     position:absolute;
     top:0px;
     left:0px;
     margin:6px 0 0 6px;
