  ...
  (\$availability == true ?
        (\$basket_quantity > 0 || !\$inventory_id || \$inventory_quantity > 0 ?
          // ADD PRODUCT TO BASKET
             '<input id="add'.\$product_id.'" class="basket_add" type="image" name="basket_add" src="grfx/basket_add.png" width="24" height="24" border="0" alt="Submit" onclick="AddToCart('.\$product_id.','.\$product_version.',\'add\'); return false;" '.(\$basket_quantity > 0 ? (\$inventory_id && \$inventory_quantity == 0 ? 'style="display:none;"' : '') : 'style="display:none;"').'>
             <input id="sub'.\$product_id.'" class="basket_sub" type="image" name="basket_sub" src="grfx/basket_sub.png" width="24" height="24" border="0" alt="Submit" onclick="AddToCart('.\$product_id.','.\$product_version.',\'sub\'); return false;" '.(\$basket_quantity > 0 ? '' : 'style="display:none;"').'>
             ...
             <input id="basket_empty'.\$product_id.'" class="basket" type="image" name="basket" src="grfx/basket-egi_add.png" width="48" height="48" border="0" alt="Submit" onClick="AddToCart('.\$product_id.','.\$product_version.',\'add\'); return false;" '.(\$basket_quantity > 0 ? 'style="display:none;"' : '').'>
             <img id="basket_full'.\$product_id.'" class="basket" src="grfx/basket-fcs.png" width="48" height="48" border="0" '.(\$basket_quantity > 0 ? '' : 'style="display:none;"').'>
           </form>
    ...
    <td align="left" valign="top" class="'.(\$availability == false || (\$inventory_quantity == 0 && \$inventory_id) ? 'inactive' : '').'">
      ...
      <div id="message_area'.\$product_id.'"'.(\$basket_quantity == 0 ? ' style="display:none;"' : '').'>
        ...
        <div class="message_button" onclick="AddToCart('.\$product_id.','.\$product_version.',\'message\'); return false;">
          <img alt="save message" src="grfx/message.png">
