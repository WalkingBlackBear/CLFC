...
function image_display_calc($data)
  { return
    ($data['image_id'] ?
    '<img src="'.PATH.'getimage.php?image_id='.$data['image_id'].'"class="product_image">'
    : '');
  };
...
function close_list_bottom()
  { return
    '</table>
    <br><br><!--<a class="help_link" href="help.php#" onclick="popup=window.open(\'test.php#\', \'popupPage\', \'height=300,width=400,left=400,scrollbars=yes,resizeable=no\'); return false" target="location_window">CLICK HERE</a>-->';
  };
