        ...
        if ($out_of_stock == 1)
          {
            ...
            $show_unit = '<img src="'.BASE_URL.PATH.'/grfx/checkmark_wht.gif"> '.Inflect::pluralize_if ($show_quantity, $ordering_unit);
            ...
            foreach (array_keys ($summary_qty) as $delcode_id)
              {
                ...
                <tr><th colspan="5" bgcolor="#444444"><font size="+1" color="#ffffff" align="center">'.$delcode_id_2_delcode[$delcode_id].' ('.$delcode_id.')</font></td></tr>
                <tr><th colspan="5">&nbsp;</th></tr>
                ';
                foreach (array_keys ($summary_qty[$delcode_id]) as $product_id)
                  {
                    ...
                    $display_page .= '
                    <tr><td width="5%">&nbsp;</td>
                    <td width="70%" colspan="3" bgcolor="#dddddd">Product quantity ('.$delcode_id_2_delcode[$delcode_id].'): </td>
