...
<table width="550" border="1" cellpadding="2" cellspacing="2" bordercolor="#333333">
  ...
  <tr>
    <td width="50" align="center">&nbsp;'.($fields["first_name"] == false ? '<font color="#3333FF"><b>*</b></font>' : '').'</td>
  ...
  <tr>
    <td width="50" align="center">&nbsp;'.($fields["username"] == false ? '<font color="#3333FF"><b>*</b></font>' : '').'</td>
...
while ($index_mem_types < $total_mem_types)
  {
    ...
    $query_mem_type_descr = "select membership_class from membership_types where membership_type_id = " . $current_row['membership_type_id'];
