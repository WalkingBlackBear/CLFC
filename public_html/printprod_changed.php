...
<font size="+3">'.ucfirst (SITE_NAME).' '.$date_today.' List of Changed Products Since Last Cycle</font>
<hr color="#000000" noshade size="2" width="100%">
'.$display;

$page_title_html = '<span class="title">Printable Product Lists</span>';
$page_subtitle_html = '<span class="subtitle">Changed Products</span>';
$page_title = 'Printable Product Lists: Changed Products';
