...
$login_message = '
  <p style="width:35%;padding:10px;margin:0 0 15px 15px;background-color:#800;float:right;border:2px solid #ffe;box-shadow:0 0 0 5px #800, 5px 5px 10px 5px #222;font-size:18px;text-align:center;color:#ffe;-webkit-transform:rotate(7deg);-moz-transform:rotate(7deg);-o-transform:rotate(7deg);transform:rotate(7deg);">
  ...
  <h3>
    Welcome to the Cloverbelt Local Food Co-Op!
  </h3><br />
