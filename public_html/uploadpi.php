...
$sqll = '
  SELECT
    ...
    '.TABLE_PRODUCT_IMAGES.'.image_desc
  FROM
    '.NEW_TABLE_PRODUCTS.'
  LEFT JOIN
                ...
                if ($data)
                  {
                    $sql = '
                      UPDATE
                        '.TABLE_PRODUCT_IMAGES.'
                      SET
                        image_desc = "'.mysql_real_escape_string ($_REQUEST['image_description']).'",
    ...
    if ($_REQUEST['confirm'] == 'yes')
      {
        ...
        <form method="post" action="'.$PHP_SELF.'?producer_id='.$producer_id.'" enctype="multipart/form-data">
        ...
        <img src="getimage.php?image_id='.$image_id.'" width="100" hspace="5" border="1"><br><br>
