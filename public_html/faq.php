  ...
  <table width="80%">
    <tr>
      <td align="left">'.$font.'
        ...
        <br>
        <b>A:</b> The member log-in page is <a href="'.HOMEPAGE.'?action=login">here</a>. If an order is open for shopping, you can open a basket by selecting a location from the &quot;Select Location&quot; function on the Shopping Panel. There are two methods of selecting products you want to buy.
        <ol>
        ...
        <li>You can edit your order up until the time that the Order Desk closes at the end of Delivery Day. The time of closing is announced at the beginning of Order Week. To edit your order (add or subtract items, change quantities, add notes), log in at <A href="'.BASE_URL.PATH.'">'.BASE_URL.PATH.'</a> . There is no need to submit your order - whatever remains in your basket when the order closes will be considered your order.
        </ol><br>
        ...
        Then you can write a check to <strong>Cloverbelt Local Food Co-Op</strong> and send it to the address on the invoice, or send an Interac E-Transfer to <strong>membership@cloverbeltlocalfoodcoop.com</strong> from your financial instituion\'s online banking.
       ...
       <!-- If paying by PayPal, email payment to <a href="mailto:'.PAYPAL_EMAIL.'">'.PAYPAL_EMAIL.'</a>-->
        ...
        <br>
        <b>A:</b> To change how you will pay, once your invoice is finalized after delivery day, you will be shown totals for different methods of payment. You can then decide to write a check, or pay online via E-Transfer. You will also be able to change your method of payment at that time. If you have questions about this at that time, contact us at <a href="mailto:'.HELP_EMAIL.'">'.HELP_EMAIL.'</a>
