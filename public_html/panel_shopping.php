...
if ( ActiveCycle::ordering_window() == 'open')
  {
    if ($basket_id)
      ...
      {
        $basket_status = '
          <em class="highlightRed">Use Select Location<br />(drop down menu above)<br />to begin shopping!</em>';
      }
  }
else
  {
...
$display .= '
    ...
    <strong>Basket Status</strong>
        ...
        <img src="grfx/product.png" width="32" height="32" align="left" hspace="2" alt="Order Info"><br>
        <b>Order Info</b>
        <ul class="fancyList1">
          ...
          <li class="last_of_group"><a href="orders_past.php">Past Customer Invoices</a></li>
        </ul>
      </td>
      <td align="left" width="50%">
...
if (CurrentMember::auth_type('institution')) $display .= '
          <!-- <li><a href="product_list.php?type=wholesale">All products (wholesale)</a></li> -->';
...
$display .= '
          ...
          <li class="last_of_group"><a href="prdcr_list.php">List of producers</a></li>
          ...
          <li><a href="product_list.php?type=new">All products (new)</a></li>
          <li class="last_of_group"><a href="product_list.php?type=changed">All products (changed)</a></li>
        </ul>
      </td>
    </tr>
  </table>';
...
$page_subtitle_html = '<span class="subtitle">Shopping Panel</span><br /><br />';
