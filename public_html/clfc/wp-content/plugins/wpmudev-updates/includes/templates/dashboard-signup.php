...
?>
	<section id="profile" class="api-key-form step1">
		<form id="api-signup" class="clearfix" action="https://premium.wpmudev.org/wdp-un.php?action=register-new" method="post"<?php echo (isset($_GET['api_error'])  || isset($_GET['clear_key']) || (isset($key_valid) && !$key_valid)) ? ' style="display:none;"' : ''; ?>>
			<fieldset>
				<legend>
		...
		<form action="https://premium.wpmudev.org/wdp-un.php?action=get_apikey" method="post" id="api-login" class="clearfix"<?php echo (isset($_GET['api_error']) || isset($_GET['clear_key']) || (isset($key_valid) && !$key_valid)) ? '' : ' style="display:none;"'; ?>>
