    ...
    if ( $donotlist_producer == "1" )
      {
        ...
        $display .= '
            <td bgcolor="#ffffdd" align="center">
              Unlisted<br>
              [<a href="'.$PHP_SELF.'?producer_id='.$producer_id.'&list_producer=relist"><strong>Relist</strong></a>]
              [<a href="'.$PHP_SELF.'?producer_id='.$producer_id.'&list_producer=suspend">Suspend</a>]
            </td>
          </tr>';
      }
    elseif ( $donotlist_producer == "2" )
      {
        ...
        $display .= '
            <td bgcolor="#ffdddd" align="center">
              ...
              [<a href="'.$PHP_SELF.'?producer_id='.$producer_id.'&list_producer=relist"><strong>Relist</strong></a>]
              [<a href="'.$PHP_SELF.'?producer_id='.$producer_id.'&list_producer=unlist">Unsuspend</a>]
            </td>
          </tr>';
      }
    else
        ...
        if ( $business_name_prior != $business_name )
          {
            ...
            if( $confirmed == "" )
              {
                $display_confirmed = '
                <td><a href="'.$PHP_SELF.'?producer_id='.$producer_id.'&confirm=yes#p_'.$producer_id.'">Confirm Listing</a></td>
            ...
            $display .= '
                <td bgcolor="#ddeedd" align="center">
                  Listed<br>
                  [<a href="'.$PHP_SELF.'?producer_id='.$producer_id.'&list_producer=unlist">Unlist</a>]
                  [<a href="'.$PHP_SELF.'?producer_id='.$producer_id.'&list_producer=suspend">Suspend</a>]
                </td>
              </tr>';
          }
    ...
    <table width="80%">
      <tr>
        <td align="center">
          ...
          Click here to make the product list changes <a href="'.$_SERVER['PHP_SELF'].'?prep=live">live</a>.
          <br>
          '.$display.'
        </td>
      </tr>
