...
// Probably need to add other table linkage elements here
    ...
    // Set the delcode_id
    $("input#delcode_id").val(this_transaction.delcode_id);
    if (document.getElementById("delcode_id").value == "") {
      stop_for_inquiry = "no value for delcode_id";
      }
...
function process_ledger_data (requested_action) {
  ...
  var delcode_id = document.getElementById("delcode_id").value;
