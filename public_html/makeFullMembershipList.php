<?php
  function startPage() {
    ...
    <head>
    	<meta charset="utf-8">
    	<title>CLFC Full Membership List</title>
  ...
  function getMemberData() {
    try {
      ...
      $memberData->execute(array(':sdate' => '2013-10-01',
                              ':edate' => $currentDate));
  ...
  function datePicker() {
    ...
    echo '<div style="text-align: center">';
      ...
      echo '<label for="startDate">Start date: </label><input type="date" name="startDate" id="startDate" value="2013-10-01" /><br />';
      echo '<label for="endDate">End date: </label><input type="date" name="endDate" id="endDate" value="'.$currentDate.'" /><br /><br />';
