...
while ( $row = mysql_fetch_array($rs) )
  {
    ...
    $sql2 = '
      ...
      WHERE
        ...
        AND customer_basket_overall.member_id = "'.mysql_real_escape_string($member_id).'"
        AND customer_basket_overall.delivery_id = "'.mysql_real_escape_string(ActiveCycle::delivery_id()).'"';
    ...
    if ( $basket_id )
      {
        $display .= '
          <b><a href="customer_invoice.php?delivery_id='.ActiveCycle::delivery_id().'&basket_id='.$basket_id.'&member_id='.$member_id.'">
...
$page_subtitle_html = '<span class="subtitle">Institutional (Wholesale Buyer) Member Contact Info</span>';
$page_title = 'Reports: Institutional (Wholesale Buyer) Member Contact Info';
