...
'./* Section V */'
  ['.strtr ($liability_statement, " 01", "  X").'] '.str_replace ("\n", "\n      ", wordwrap ('I affirm that all statements made about my farm and products in this application are true, correct and complete and I have given a truthful representation of my operation, practices, and origin of products. ', 75, "\n", true));
...
if ($_POST['action'] == 'Update')
  ...
  $welcome_message .= '<p><em>Thank you for your interest in becoming a producer member of '.SITE_NAME.'.<br /><br />'.SITE_NAME.' customers and producers are interested in local foods and products produced with sustainable practices that demonstrate good stewardship of the environment. Upon approval this form will register you to sell products within '.SITE_NAME.'.  Please read the <a href="'.TERMS_OF_SERVICE.'" target="_blank">Terms of Service</a>, and then complete the following information and click submit.</em></p>';
        ...
        <td>
          <table id="section1b">
            ...
            <tr>
              ...
              Use this only if you have your own website.<br /></td>
            </tr>
          </table>
        </td>
      </tr>
          ...
          <table id="section4a" width="100%">
            <tr>
              <td class="form_key"><strong>Insurance, Licenses, and Tests:</strong><br>
                ...
                any licenses and tests that you have available. (if applicable)</td>
            </tr>
            <tr>
              <td><textarea cols="80" rows="2" name="licenses_insurance">'.htmlspecialchars ($licenses_insurance, ENT_QUOTES).'</textarea></td>
            </tr>
          </table>
        </td>
      </tr>
        ...
        <td>
          <table id="section4b" width="100%">
            <tr>
              ...
              List any products you are selling as organic.</td>
            </tr>
            <tr>
        ...
        <td>
          <table id="section4c" width="100%">
            <tr>
              ...
              List orgainic certifying agency&#146;s name and address. (if applicable)</td>
            </tr>
            <tr>
              <td><textarea cols="80" rows="2" name="certifying_agency">'.htmlspecialchars ($certifying_agency, ENT_QUOTES).'</textarea></td>
            </tr>
          </table>
        </td>
      </tr>
...
<input type="hidden" name="organic_cert" value="0" />
'./* Section V */'
      <tr>
          ...
          <table id="section5a">
            <tr>
              <td>
                ...
                and origin of products. I have read all of '.SITE_NAME.'&#146;s <a href="'.TERMS_OF_SERVICE.'" target="_blank">
                Member Information Statement</a> and fully understand and am willing to comply with them.
              </td>
            </tr>
            <tr>
              <td align="center"><br /><input type="checkbox" name="liability_statement" value="1"'.$liability_statement_check.'> I agree</td>
            </tr>
          </table>
        </td>
      </tr>
...
$display_form_html .= '
      <tr>
        <td align="center">
          <br /><input type="submit" name="action" value="'.($changed_information ? 'Update' : 'Submit').'">
        </td>
      </tr>
      </tbody>
    </table>
...
$page_title_html = '<h4 class="center">Producer Info -->';
$page_subtitle_html = '<span class="subtitle">'.(! $producer_id ? 'New Producer Application Form' : 'Edit Producer Information').'</h4>';
