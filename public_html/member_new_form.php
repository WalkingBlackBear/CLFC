...
// THIS FILE IS CUSTOMIZED FOR CLOVERBELT LOCAL FOOD CO-OP
...
$welcome_message = '
  <p><em>Thank you for your interest in becoming a member of '.SITE_NAME.'.<br /><br />
  '.SITE_NAME.' customers, producers, and supporters are interested in local foods and products
  produced with sustainable practices that demonstrate good stewardship of the environment.<br /><br />';

$display_form_top .= $welcome_message.'
  To become a member, please read the <a href="http://www.cloverbeltlocalfoodcoop.com/docs/CLFCMembershipHandbook.pdf" target="_blank">
  Membership Handbook</a>, and then complete the following information and click submit.</em></p>';
      ...
      <tr>
        <td>
          <table>
            ...
            <tr>
              <td class="form_key"><strong>*&nbsp;City/Prov/Postal Code:</strong></td>
            ...
            <tr>
              <td class="form_key"><strong>*&nbsp;Country:</strong></td>
        ...
        <td>
          <table>
            <tr>
              ...
              <td align="top"><input maxlength="20" size="25" name="username" value="'.$username.'" tabindex="27"></td>
              <td align="top"><img src="securimage_show.php?sid='.time().'" alt="Human validation text" title="Human validation text"></td>
            </tr>
            <tr>
              ...
              <td>*&nbsp;Enter the human validation text below.</td>
            </tr>
            <tr>
              ...
              <td class="form_key" valign="top"><strong>&nbsp;Validation: </strong><input maxlength="10" size="10" name="human_check" value="" tabindex="30"></td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    if ($pending == 1)
    ...
    else // Pending = 0
      {
        $membership_disposition = '
          ...
          been automatically activated and you may <a href="'.BASE_URL.PATH.'index.php?action=login">
...
//      '.SITE_MAILING_ADDR.'</p>';
/*    $membership_disposition .= '
      <p>Thank you for joining the Cloverbelt Local Food Co-Op!  Your membership has been entered, and will soon be activated.  Payment has already been received, you do not need to take any action at this time.</p>';
...
*/
    ...
    $email_preamble = '
      <p>Following is a copy of the membership information submitted to '.SITE_NAME.'.</p>';
...
if ($producer == 'yes' && count ($error_array) == 0)
  {
    ...
    $display_form_message .= '
      <p>You will be a producer member.</p>
      <p>You can access the <a href="producer_form.php">producer registration form</a> immediately or you can return later to complete the form. It is a lengthy form, and you may wish to print it prior to filling it out online.<br><br></p>';
  }
if ($display_form_message) $display_form_message .= '</div>';

$page_title_html = '<h4 class="center">Member Resources --> ';
$page_subtitle_html = '<span class="subtitle">New Member Application</span></h4>';
