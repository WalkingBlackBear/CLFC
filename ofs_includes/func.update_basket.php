...
// * action                ['checkout'|set_checkout'|'un_checkout'|'set_delcode']
// * basket_id             basket_id 
...
$admin_override = true;
    ...
    switch ($data['action'])
      {
        ...
        case 'un_checkout':
          ...
          break;
          // update the delcode (Pickup|Home|Work)
        case 'set_delcode':
          $update_delcode = true;
          break;
        default:
    ...
    // Update the basket with a new delcode and information related to the new delcode
    if ($update_delcode)
      {
...
debug_print ("INFO: 892573 ", $row_delcode, basename(__FILE__).' LINE '.__LINE__);
...
debug_print ("INFO: 892573 ", $query_update_basket, basename(__FILE__).' LINE '.__LINE__);
        ...
        // Otherwise error
          ...
          {
            die(debug_print('ERROR: 898952 ', 'requested delcode does not exist or is not available', basename(__FILE__).' LINE '.__LINE__));
          }
      }
        ...
        if ($basket_info['order_cost'] != 0 &&
            ...
            $basket_info['checked_out'] != 0)
          {
            ...
            $ledger_status = basket_item_to_ledger(array (
              ...
              'delcode_id' => $basket_info['delcode_id'],
