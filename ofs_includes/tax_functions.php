...
// 
// The function will return the city_code, city_tax, county_code, county_tax,
// state_code, and state tax.
...
function tax_rates ($delivery_id)
  {
...
// Modified for NFC old taxes
if ($delivery_id <= 50) { $state_tax_rate = 0; }
//if ($delivery_id < 10) { $state_tax_rate = -0; }
else { $state_tax_rate = STATE_TAX; } ;
